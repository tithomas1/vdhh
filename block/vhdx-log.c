                              ...
                              bool convert_endian)
{
    ...
    desc_entries = vmx_try_blockalign(bs->file,
                               ...
                               VHDXLogDataSector *data)
{
    ...
    buffer = vmx_blockalign(bs, VHDX_LOG_SECTOR_SIZE);
                          ...
                          VHDXLogSequence *logs)
{
    ...
    data = vmx_blockalign(bs, VHDX_LOG_SECTOR_SIZE);
                   ...
                   Error **errp)
{
    ...
    *flushed = false;
    ...
    if (s->log.hdr == NULL) {
        s->log.hdr = vmx_blockalign(bs, sizeof(VHDXLogEntryHeader));
    }
                          ...
                          void *data, uint32_t length, uint64_t offset)
{
    ...
    buffer = vmx_blockalign(bs, total_length);
     ...
     * destination */
    merged_sector = vmx_blockalign(bs, VHDX_LOG_SECTOR_SIZE);
