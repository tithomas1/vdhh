...
struct SCSIRequest {
    ...
    size_t            resid;
    SCSICommand       cmd;
    VeertuNotifiers      cancel_notifiers;
...
#define SCSI_DEVICE(obj) obj
#define SCSI_DEVICE_CLASS(klass) klass
#define SCSI_DEVICE_GET_CLASS(obj) ((VeertuType *)obj)->class
...
struct SCSIBusInfo {
    ...
    VeertuSGList *(*get_sg_list)(SCSIRequest *req);
