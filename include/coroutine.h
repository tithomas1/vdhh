 ...
 *
 * Use vmx_coroutine_enter() to actually transfer control to the coroutine.
 */
 ...
 */
void vmx_coroutine_enter(Coroutine *coroutine, void *opaque);
 ...
 */
Coroutine *coroutine_fn vmx_coroutine_self(void);
