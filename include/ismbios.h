...
static inline void smbios_entry_add(QemuOpts *opts) {}
static inline void smbios_set_cpuid(uint32_t version, uint32_t features) {}
static inline void smbios_set_defaults(const char *manufacturer, const char *product,
                         const char *version, bool legacy_mode,
                         bool uuid_encoded) {}
static inline uint8_t *smbios_get_table_legacy(size_t *length) {return NULL;}
