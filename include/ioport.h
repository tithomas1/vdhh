...
extern const MemAreaOps unassigned_io_ops;
#endif
...
typedef struct PortioList {
    ...
    VeertuType *owner;
    struct VeertuMemArea *address_space;
    unsigned nr;
    struct VeertuMemArea **regions;
    void *opaque;
    const char *name;
} PortioList;

void portio_list_init(PortioList *piolist, VeertuType *owner,
