...
void vmx_system_vmstop_request(RunState reason);
...
typedef enum {
    VGA_NONE, VGA_STD, VGA_CIRRUS, VGA_VMWARE, VGA_QXL,
...
extern uint8_t vmx_extra_params_fw[2];
...
void device_add_bootindex_property(VeertuType *obj, int32_t *bootindex,
...
typedef void QEMUBootSetHandler(void *opaque, const char *boot_order,
                                Error **errp);
void vmx_register_boot_set(QEMUBootSetHandler *func, void *opaque);
void vmx_boot_set(const char *boot_order, Error **errp);
...
extern QemuOptsList vmx_legacy_drive_opts;
extern QemuOptsList vmx_common_drive_opts;
extern QemuOptsList vmx_drive_opts;
extern QemuOptsList vmx_chardev_opts;
extern QemuOptsList vmx_device_opts;
extern QemuOptsList vmx_netdev_opts;
extern QemuOptsList vmx_net_opts;
extern QemuOptsList vmx_global_opts;
extern QemuOptsList vmx_mon_opts;
