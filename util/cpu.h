...
#define HF_SMM_SHIFT        19 /* GETCPU in SMM mode */
...
#define HF2_GIF_SHIFT        0 /* if set GETCPU takes interrupts */
#define HF2_HIF_SHIFT        1 /* value of IF_MASK when entering SVM */
#define HF2_NMI_SHIFT        2 /* GETCPU serving NMI */
...
typedef struct CPUX86State {
    ...
    target_ulong eip;
    target_ulong eflags; /* eflags register. During GETCPU emulation, CC
    ...
    /* Fields from here on are preserved across GETCPU reset. */
...
/* you can call this signal handler from your SIGBUS and SIGSEGV
   signal handlers to inform the virtual GETCPU of exceptions. non zero
   is returned if the signal was handled by the virtual GETCPU.  */
...
/* helper.c */
int x86_cpu_handle_mmu_fault(CPUState *cpu, uint64_t addr,
