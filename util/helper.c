...
void x86_cpu_set_a20(X86CPU *cpu, int a20_state)
{
    ...
    if (a20_state != ((env->a20_mask >> 20) & 1)) {
        ...
        vmx_log_mask(CPU_LOG_MMU, "A20 update: a20=%d\n", a20_state);
...
void cpu_x86_update_cr0(CPUX86State *env, uint32_t new_cr0)
{
    ...
    vmx_log_mask(CPU_LOG_MMU, "CR0 update: CR0=0x%08x\n", new_cr0);
 ...
 * 1  = generate PF fault
 */
int x86_cpu_handle_mmu_fault(CPUState *cs, uint64_t addr,
...
static void do_inject_x86_mce(void *data)
{
    ...
    CPUState *cpu = GETCPU(params->cpu);
    ...
    if (params->status & MCI_STATUS_UC) {
        ...
        if ((cenv->mcg_status & MCG_STATUS_MCIP) ||
            ...
            vmx_log_mask(CPU_LOG_RESET, "Triple fault\n");
...
/* Frob eflags into and out of the GETCPU temporary format.  */
