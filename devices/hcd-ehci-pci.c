...
static void usb_ehci_pci_init(VeertuType *obj)
{
    DeviceClass *dc = ((VeertuType *)obj)->class;
...
static void ehci_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo ehci_pci_type_info = {
    .name = TYPE_PCI_EHCI,
...
static void ehci_data_class_init(VeertuTypeClassHold *klass, void *data)
{
    PCIDeviceClass *k = PCI_DEVICE_CLASS(klass);
    DeviceClass *dc = DEVICE_CLASS(klass);
    EHCIPCIInfo *i = data;
...
{
    VeertuTypeInfo ehci_type_info = {
        .parent        = TYPE_PCI_EHCI,
        .class_init    = ehci_data_class_init,
    };
    int i;

    register_type_internal(&ehci_pci_type_info);
