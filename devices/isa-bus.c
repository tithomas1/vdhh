...
static void isa_bus_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo isa_bus_info = {
    .name = TYPE_ISA_BUS,
    .parent = TYPE_BUS,
...
/*
 * isa_get_irq() returns the corresponding vmx_irq entry for the i8259.
 *
...
{
    mem_area_add_child(isabus->address_space_io, start, io);
                              ...
                              void *opaque, const char *name)
{
    ...
    portio_list_init(&piolist, VeertuTypeHold(dev), pio_start, opaque, name);
    portio_list_add(&piolist, isabus->address_space_io, start);
}

static void isa_device_init(VeertuType *obj)
{
...
static void isabus_bridge_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo isabus_bridge_info = {
    .name          = "isabus-bridge",
...
static void isa_device_class_init(VeertuTypeClassHold *klass, void *data)
{
    DeviceClass *k = DEVICE_CLASS(klass);
    k->bus_type = TYPE_ISA_BUS;
}

static const VeertuTypeInfo isa_device_type_info = {
...
{
    register_type_internal(&isa_bus_info);
    register_type_internal(&isabus_bridge_info);
    register_type_internal(&isa_device_type_info);
}
