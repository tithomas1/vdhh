...
static void ioapic_common_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo ioapic_common_type = {
...
{
    register_type_internal(&ioapic_common_type);
}
