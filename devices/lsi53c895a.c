...
#define CASE_SET_REG32(name, addr) \
    ...
    case 0x07: /* GPREG0 */
        break;
    case 0x08: /* SFBR */
        /* The GETCPU is not allowed to write to this register.  However the
...
static const MemAreaOps lsi_mmio_ops = {
    .read = lsi_mmio_read,
...
static const MemAreaOps lsi_ram_ops = {
    .read = lsi_ram_read,
    .write = lsi_ram_write,
    .endianness = DEVICE_NATIVE_ENDIAN,
};
...
static const MemAreaOps lsi_io_ops = {
    .read = lsi_io_read,
    .write = lsi_io_write,
    .endianness = DEVICE_NATIVE_ENDIAN,
    .impl = {
...
static const VMStateDescription vmstate_lsi_scsi = {
    ...
    .fields = (VMStateField[]) {
        VMSTATE_PCI_DEVICE(parent, LSIState),
...
static int lsi_scsi_init(PCIDevice *dev)
{
    ...
    memory_area_init_io(&s->mmio_io, VeertuTypeHold(s), &lsi_mmio_ops, s,
                          "lsi-mmio", 0x400);
    memory_area_init_io(&s->ram_io, VeertuTypeHold(s), &lsi_ram_ops, s,
                          "lsi-ram", 0x2000);
    memory_area_init_io(&s->io_io, VeertuTypeHold(s), &lsi_io_ops, s,
                          "lsi-io", 256);
...
static void lsi_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo lsi_info = {
...
static void lsi53c810_class_init(VeertuTypeClassHold *klass, void *data)
{
    PCIDeviceClass *k = PCI_DEVICE_CLASS(klass);
...
static VeertuTypeInfo lsi53c810_info = {
    .name          = TYPE_LSI53C810,
...
{
    register_type_internal(&lsi_info);
    register_type_internal(&lsi53c810_info);
}