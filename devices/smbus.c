...
static void smbus_device_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo smbus_device_type_info = {
...
{
    register_type_internal(&smbus_device_type_info);
}