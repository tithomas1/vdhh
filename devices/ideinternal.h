 ...
 * non-internal declarations are in ide.h
 */
#include <ide.h>
#include <isa.h>
#include "emudma.h"
...
#define IDE_DEVICE(obj) obj
#define IDE_DEVICE_CLASS(klass) klass
#define IDE_DEVICE_GET_CLASS(obj) ((VeertuType *)obj)->class
