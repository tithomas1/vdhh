...
static const VMStateDescription vmstate_ich9_ahci = {
    ...
    .version_id = 1,
    .fields = (VMStateField[]) {
        VMSTATE_PCI_DEVICE(parent, AHCIPCIState),
...
static void pci_ich9_uninit(PCIDevice *dev)
{
    ...
    ahci_uninit(&d->ahci);
    vmx_free_irq(d->ahci.irq);
}

static void ich_ahci_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo ich_ahci_info = {
    .name          = TYPE_ICH9_AHCI,
...
{
    register_type_internal(&ich_ahci_info);
}