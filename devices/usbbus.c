...
static void usb_bus_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo usb_bus_info = {
    .name = TYPE_USB_BUS,
    .parent = TYPE_BUS,
...
void usb_claim_port(USBDevice *dev, Error **errp)
{
    ...
    if (0) {
        ...
        if (bus->nfree == 1 && strcmp(get_typename(VeertuTypeHold(dev)), "usb-hub") != 0) {
...
static void usb_device_class_init(VeertuTypeClassHold *klass, void *data)
{
...
static const VeertuTypeInfo usb_device_type_info = {
...
{
    register_type_internal(&usb_bus_info);
    register_type_internal(&usb_device_type_info);
}
