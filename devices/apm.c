...
static const MemAreaOps apm_ops = {
              ...
              void *arg)
{
    ...
    /* ioport 0xb2, 0xb3 */
    memory_area_init_io(&apm->io, VeertuTypeHold(dev), &apm_ops, apm, "apm-io", 2);
    mem_area_add_child(pci_address_space_io(dev), APM_CNT_IOPORT,
                                &apm->io);
}
