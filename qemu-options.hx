...
kvm or tcg can be available. By default, tcg is used. If there is more
...
DEF("vga", HAS_ARG, QEMU_OPTION_vga,
    "-vga [std|cirrus|vmware|qxl|tcx|cg3|none]\n"
...
DEF("expose-hyperv", 0, QEMU_OPTION_expose_hyperv,
    "-expose-hyperv       Expose Hyper-V interface to guest\n",
    QEMU_ARCH_ALL)
STEXI
@item -expose-hyperv
@findex -expose-hyperv
Expose Hyper-V interface to guest (Useful for optimizing Windows guests).
ETEXI
